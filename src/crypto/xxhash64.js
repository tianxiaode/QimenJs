 ...
 * @returns XXH64哈希值
 */
function calculateXXH64(str, seed) {
    // 将字符串转换为UTF-8字节数组
    ...
    class Uint64 {
        ...
        static mul(a, b) {
            ...
            c48 = (c48 >>> 0) + (a48 * b48);
            return new Uint64(((c48 << 16) | (c32 & 0xFFFF)) >>> 0, ((c16 << 16) | (c00 & 0xFFFF)) >>> 0);
        }
        // XOR
        static xor(a, b) {
    ...
    if (len >= 32) {
        ...
        for (; offset <= len - 32; offset += 32) {
            let data1 = new Uint64((input[offset + 4] << 24) | (input[offset + 5] << 16) | (input[offset + 6] << 8) | input[offset + 7], (input[offset + 0] << 24) | (input[offset + 1] << 16) | (input[offset + 2] << 8) | input[offset + 3]);
            let data2 = new Uint64((input[offset + 12] << 24) | (input[offset + 13] << 16) | (input[offset + 14] << 8) | input[offset + 15], (input[offset + 8] << 24) | (input[offset + 9] << 16) | (input[offset + 10] << 8) | input[offset + 11]);
            let data3 = new Uint64((input[offset + 20] << 24) | (input[offset + 21] << 16) | (input[offset + 22] << 8) | input[offset + 23], (input[offset + 16] << 24) | (input[offset + 17] << 16) | (input[offset + 18] << 8) | input[offset + 19]);
            let data4 = new Uint64((input[offset + 28] << 24) | (input[offset + 29] << 16) | (input[offset + 30] << 8) | input[offset + 31], (input[offset + 24] << 24) | (input[offset + 25] << 16) | (input[offset + 26] << 8) | input[offset + 27]);
