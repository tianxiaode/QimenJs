...
function calculateXXH64(str: string, seed: number): string {
    ...
    if (len >= 32) {
        ...
        for (; offset <= len - 32; offset += 32) {
            ...
            v1 = Uint64.add(
                Uint64.rotl(Uint64.add(Uint64.mul(v1, PRIME64_2), data1), 31),
                PRIME64_1
            );
            v2 = Uint64.add(
                Uint64.rotl(Uint64.add(Uint64.mul(v2, PRIME64_2), data2), 31),
                PRIME64_1
            );
            v3 = Uint64.add(
                Uint64.rotl(Uint64.add(Uint64.mul(v3, PRIME64_2), data3), 31),
                PRIME64_1
            );
            v4 = Uint64.add(
                Uint64.rotl(Uint64.add(Uint64.mul(v4, PRIME64_2), data4), 31),
                PRIME64_1
            );
        }
