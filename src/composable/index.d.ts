 ...
 */
export type { IComposable, IComposableBase, AbilityHostBase, IExposeResult, DescriptorFactoryFn, DisposerFactoryFn, IPrecompiledAbility, IPrecompilableAbility, IAbilityRegistrationEntry, IAbilityRegistrationOptions, AbilityDecorator, ExtractHostType, AbilityProperties, } from './types/composable';
