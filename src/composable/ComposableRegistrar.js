...
exports.ComposableRegistrar = void 0;
...
class ComposableRegistrar extends registry_1.RegistrarBase {
    constructor() {
         ...
         * value: 能力实例
         */
        this._abilityInstances = new Map();
    }
    /**
     * 注册能力
     *
    ...
    register(entry, abilityClass, options) {
        ...
        this.storage.registry.set(entry.name, {
            ...
            description: (options === null || options === void 0 ? void 0 : options.immediate) ? 'Immediate' : undefined,
        });
        // 如果是立即预编译，则立即预编译
