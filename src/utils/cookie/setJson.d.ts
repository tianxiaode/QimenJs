 ...
 */
export declare function setJson(name: string, value: any, expires?: number | Date, path?: string, domain?: string, secure?: boolean, sameSite?: 'Strict' | 'Lax' | 'None'): boolean;
//# sourceMappingURL=setJson.d.ts.map