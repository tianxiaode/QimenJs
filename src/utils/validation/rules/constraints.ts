...
function createComparisonValidator(
    ...
    return (value: any): ValidationRuleResult => {
        // 对于相等性比较，不需要必须是数字
        // 但对于大小比较，仍需要检查是否为数字
        if ([ComparisonOperation.GREATER_THAN, 
             ComparisonOperation.GREATER_THAN_OR_EQUAL,
             ComparisonOperation.LESS_THAN,
             ComparisonOperation.LESS_THAN_OR_EQUAL].includes(operation)) {
 ...
 * 检查是否有最小值
 */
export function hasMinValue(min: number, strict: boolean = true): (value: any) => ValidationRuleResult {
 ...
 * 检查是否有最大值
 */
export function hasMaxValue(max: number, strict: boolean = true): (value: any) => ValidationRuleResult {
 ...
 * 检查值是否在范围内
 */
export function isBetween(min: number, max: number, strict: boolean = true): (value: any) => ValidationRuleResult {
  return allRules(
    isGreaterThanOrEqual(min, strict),
    isLessThanOrEqual(max, strict)
  );
}
 ...
 * 检查值是否大于某个值
 */
export function isGreaterThan(compareValue: number, strict: boolean = true): (value: any) => ValidationRuleResult {
 ...
 * 检查值是否大于等于某个值
 */
export function isGreaterThanOrEqual(compareValue: number, strict: boolean = true): (value: any) => ValidationRuleResult {
  return createComparisonValidator(ComparisonOperation.GREATER_THAN_OR_EQUAL, compareValue, strict);
}

/**
 * 检查值是否小于某个值
 */
export function isLessThan(compareValue: number, strict: boolean = true): (value: any) => ValidationRuleResult {
 ...
 * 检查值是否小于等于某个值
 */
export function isLessThanOrEqual(compareValue: number, strict: boolean = true): (value: any) => ValidationRuleResult {
 ...
 * 检查值是否等于期望值
 */
export function isEqualTo(expected: any, strict: boolean = true): (value: any) => ValidationRuleResult {
 ...
 * 检查值是否不等于某个值
 */
export function isNotEqualTo(notExpected: any, strict: boolean = true): (value: any) => ValidationRuleResult {
...
function checkCollectionMembership(
  ...
  if (Array.isArray(collection)) {
    ...
    return createValidationFailure(ValidationErrorCode.INVALID_COLLECTION_TYPE, { value, collection });
  }
 ...
 * 检查值是否不在集合中
 */
export function isNotInCollection(collection: any[] | Set<any>): (value: any) => ValidationRuleResult {
  return (value: any): ValidationRuleResult => {
    return checkCollectionMembership(
      collection,
      value,
...
export function isPropertyKey(value: any): ValidationRuleResult {
  const isValid = typeof value === 'string' || typeof value === 'symbol' || typeof value === 'number';
