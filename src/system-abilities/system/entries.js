...
exports.EventAbilityEntry = {
    name: abilities_1.EventAbilityName,
...
exports.DomEventsAbilityEntry = {
    name: abilities_1.DomEventsAbilityName,
    description: '为类添加DOM事件能力',
    deps: [abilities_1.EventAbilityName],
...
exports.DomainConfigAbilityEntry = {
    name: abilities_1.DomainAbilityName,
...
exports.SystemConfigAbilityEntry = {
    name: abilities_1.SystemAbilityName,
