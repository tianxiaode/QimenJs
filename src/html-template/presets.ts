 ...
 *
 * 命名规则：data-content="prefix:name"
 * - prefix = 功能区域（如 input, header, body, footer）
 * - name = 具体内容项（如 label, close, confirm）
 * - 不使用 data-ref，全部统一为 data-content
 */
...
export const SELECT_TEMPLATE = `
    ...
    <select data-content="select:field" class="q-select__field"></select>
`;
 ...
 * - table:bodyScroll — 表体容器（虚拟列表滚动容器）
 */
export const TABLE_TEMPLATE = `
    <div class="q-table__header" data-content="table:headerRow"></div>
    <div class="q-table__body" data-content="table:bodyScroll" style="overflow-y: auto;"></div>
`;
...
export const DIALOG_TEMPLATE = `
    <div class="q-dialog__header" data-content="dialog:header">
        ...
        <button class="q-dialog__close" data-content="dialog:close">&times;</button>
    </div>
...
export const TOAST_NOTIFICATION_TEMPLATE = `
    <div class="q-toast__header">
        ...
        <button class="q-toast__close" data-content="toast:close">&times;</button>
    </div>
    <div class="q-toast__icon" data-content="toast:icon"></div>
    <span class="q-toast__message" data-content="toast:message"></span>
`;
...
export const MSGBOX_TEMPLATE = `
    ...
    <div class="q-msgbox__body">
        ...
        <input class="q-msgbox__input" data-content="msgbox:field" style="display:none;" />
    </div>
    <div class="q-msgbox__footer">
        <button class="q-msgbox__btn q-msgbox__btn--cancel" data-content="msgbox:cancel">取消</button>
        <button class="q-msgbox__btn q-msgbox__btn--confirm" data-content="msgbox:confirm">确定</button>
    </div>
`;
