...
exports.Registry = exports.RegistryHub = void 0;
...
class RegistryHub {
     ...
     */
    static use(registrar, force = false) {
        // 1. 优先检查锁定状态
        if (this.isLocked) {
            throw new errors_1.RegistryHubLockedError({
        ...
        if (this.registars.has(name) && !force) {
            throw new errors_1.RegistryHubConflictError(name);
        }
...
exports.RegistryHub = RegistryHub;
_a = RegistryHub;
/**
 * 存储所有注册器实例
 ...
 */
exports.Registry = RegistryHub.root;
//# sourceMappingURL=RegistryHub.js.map