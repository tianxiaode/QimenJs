 ...
 * 通过统一的错误代码便于错误分类和处理
 */
export declare enum RegistryHubErrorCode {
 ...
 * 提供了统一的错误处理机制和上下文信息
 */
export declare abstract class RegistryHubError extends ErrorBase {
    /**
     * 创建一个新的注册中心错误实例
     *
 ...
 */
export declare class RegistryHubLockedError extends RegistryHubError {
    /**
     * 创建一个新的注册中心锁定错误实例
     *
 ...
 */
export declare class RegistryHubConflictError extends RegistryHubError {
    /**
     * 创建一个新的注册冲突错误实例
     *
