import type { BooleanRule, DateRule, FormatRule, NumberRule, PasswordRule, SplitRule, StringRule, ValidationRule } from './rule';
/**
 * 缓存类型（简化版，避免依赖 cache 包）
 */
export type CacheType = 'memory' | 'local' | 'session' | 'custom';
/**
