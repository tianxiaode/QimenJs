 ...
 * ```
 */
export declare class EventScope implements IEventScope {
     ...
     */
    constructor(bus: EventBus, logger?: ILogger | undefined);
    /**
     * 记录作用域相关的日志
     *
     * @param level - 日志级别
     ...
     * @param data - 附加数据
     */
    logScope(level: LogLevel, action: ScopeLogAction, data?: Record<string, any>): void;
    /**
     * 触发事件
     *
