...
const MinutePanelComponentDefs: Definitions = {
    options: {
        value: null,
        previewData: null,
        showPrevField: true,
...
MinutePanelComponent.define(MinutePanelComponentDefs);
