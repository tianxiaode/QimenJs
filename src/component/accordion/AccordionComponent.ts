/**
 * AccordionComponent 手风琴组件
 *
 * 继承 ItemGroupComponent，用 withTemplate 覆盖模板。
 * body 只声明 type，所有逻辑放 class 体。
 */
...
const AccordionBase = ItemGroupComponent.withTemplate({
    tpl: {
        tag: 'div',
        className: 'q-accordion',
        children: [{ tag: 'div', name: 'items', className: 'q-accordion__items' }],
    },
    body: { type: 'Accordion' },
});

export class AccordionComponent extends AccordionBase {
    private _mode: AccordionMode = 'single';
