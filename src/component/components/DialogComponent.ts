 ...
 *
 * abilities: [OpenableAbility, OverlayAbility, AnimationAbility]
 * 支持打开/关闭动画、z-index 管理
 */
...
export class DialogComponent extends ComponentBase {
    static override readonly abilities = [OpenableAbility, OverlayAbility, AnimationAbility];
    ...
    constructor(props?: Record<string, any>) {
        ...
        this.el.innerHTML = `
            <div class="q-dialog__header" data-ref="header">
                <span class="q-dialog__title">${props?.title || ''}</span>
