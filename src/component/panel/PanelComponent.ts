...
import { TemplateComponent, PANEL_TEMPLATE } from '@qimenjs/component-core';
...
export let PanelComponent = TemplateComponent
    .withTemplate(PANEL_TEMPLATE)
    .with([ExpandArrowAbility]);

PanelComponent.prototype.type = 'Panel';
 ...
 */
PanelComponent.prototype._initPanel = function(props?: PanelProps): void {
    // 设置标题
    if (props?.title) {
