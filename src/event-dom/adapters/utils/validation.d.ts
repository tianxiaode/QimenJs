 ...
 */
export declare function validateDoubleTap(now: number, lastTapTime: number, currentX: number, currentY: number, lastTapX: number, lastTapY: number, maxInterval: number, maxDistance: number): boolean;
/**
 * 验证长按（long press）手势
 ...
 */
export declare function validateLongPress(startX: number, startY: number, currentX: number, currentY: number, maxDistance: number): boolean;
/**
 * 验证滑动（swipe）手势
 ...
 */
export declare function validateSwipe(distance: number, duration: number, minDistance: number, maxDuration: number, minVelocity: number): boolean;
/**
 * 验证轻敲（tap）手势
 ...
 */
export declare function validateTap(duration: number, distance: number, maxDuration: number, maxDistance: number): boolean;
