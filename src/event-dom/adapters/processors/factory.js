...
const errors_1 = require("../../../kernel/errors"); // 导入新错误类
const codes_1 = require("../../../errors/codes"); // 导入错误代码
/**
...
function createGestureProcessor(descriptor, emit) {
    ...
    if (!ProcessorCtor) {
        throw new errors_1.GestureError(`Unknown gesture processor: ${descriptor.processor}`, codes_1.KernelErrorCode.UNKNOWN_GESTURE_PROCESSOR, {
