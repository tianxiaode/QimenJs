 ...
 */
export declare class SimpleWorkerManager extends WorkerManagerBase {
    private handlers;
    /**
     * 构造函数
     *
     ...
     */
    constructor(url: string, handlers?: WorkerManagerOptions);
    /**
     * 处理从 Worker 接收到的消息
     *
...
//# sourceMappingURL=SimpleWorkerManager.d.ts.map