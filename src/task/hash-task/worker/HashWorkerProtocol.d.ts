 ...
 * 主线程向Worker发送的消息联合类型
 */
export type HashWorkerMessage = HashWorkerInitMessage | HashWorkerUpdateMessage | HashWorkerFinalMessage | HashWorkerResetMessage;
/**
 * =========================
 * Worker → 主线程 通信协议
 * =========================
...
//# sourceMappingURL=HashWorkerProtocol.d.ts.map