...
exports.DataProcessor = exports.DataProcessorRegistrar = exports.DataProcessorRegistrarName = void 0;
const registrars_1 = require("../../registry/registrars");
 ...
 */
class DataProcessorRegistrar extends registrars_1.RegistrarBase {
    constructor() {
        super(...arguments);
 ...
 * 数据处理注册器实例（便捷访问）
 */
exports.DataProcessor = DataProcessorRegistrar.getInstance();
