...
exports.TreeViewAbility = void 0;
const composable_1 = require("../../../composable");
class TreeViewAbility extends composable_1.AbilityBase {
    expose() {
        return {
    ...
    refreshView() {
        ...
        // 根据配置决定生成何种格式
        const newItems = schema.useFlat !== false ? this.generateFlatItems() : this.generateTreeData();
...
exports.TreeViewAbility = TreeViewAbility;
//# sourceMappingURL=TreeViewAbility.js.map