...
exports.ResponseAnalyzerHandler = void 0;
const ResponseAnalyzerHandler = async (context) => {
    // 卫语句：物理层彻底失败则跳过
    if (context.metadata.isTransportFailure || !context.http.rawResponse)
        return;
...
exports.ResponseAnalyzerHandler = ResponseAnalyzerHandler;
