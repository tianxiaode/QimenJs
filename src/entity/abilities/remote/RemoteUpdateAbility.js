 ...
 */
class RemoteUpdateAbility extends composable_1.AbilityBase {
    /**
     * 暴露远程更新操作的方法
     *
    ...
    expose() {
        ...
        return {
            ...
            update: async (data) => {
                ...
                // 1. 状态锁保护
                if (state.loading) {
                    throw new errors_1.EntityError('Operation in progress, please wait.', errors_1.KernelErrorCode.ENTITY_OPERATION_IN_PROGRESS);
                }
                // 2. 发起请求
...
exports.RemoteUpdateAbility = RemoteUpdateAbility;
//# sourceMappingURL=RemoteUpdateAbility.js.map