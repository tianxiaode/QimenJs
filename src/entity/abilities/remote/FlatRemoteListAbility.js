...
exports.FlatRemoteListAbility = void 0;
const composable_1 = require("../../../composable");
class FlatRemoteListAbility extends composable_1.DebounceAbilityBase {
    expose() {
        // 内部防抖执行器
    ...
    async internalList(force = false) {
        const { host } = this;
...
exports.FlatRemoteListAbility = FlatRemoteListAbility;
//# sourceMappingURL=FlatRemoteListAbility.js.map