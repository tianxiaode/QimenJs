...
exports.LocalListAbility = void 0;
const composable_1 = require("../../../composable");
class LocalListAbility extends composable_1.AbilityBase {
    expose() {
        const { host } = this;
        const { state } = host;
        return {
...
exports.LocalListAbility = LocalListAbility;
//# sourceMappingURL=LocalListAbility.js.map