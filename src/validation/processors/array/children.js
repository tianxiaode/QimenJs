...
exports.ArrayChildrenProcessor = void 0;
const errors_1 = require("../../errors");
const core_1 = require("../../core");
const ArrayChildrenProcessor = async (context) => {
    const { value, rule, path } = context;
    if (!rule.itemRule || !Array.isArray(value))
        return;
    ...
    const tasks = value.map(async (item, index) => {
        ...
        await (0, core_1.doValidate)(item, itemRule, {
            ...context,
            path: childPath,
...
exports.ArrayChildrenProcessor = ArrayChildrenProcessor;
