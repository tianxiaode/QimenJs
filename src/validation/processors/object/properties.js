...
exports.ObjectPropertiesProcessor = void 0;
const core_1 = require("../../core");
const errors_1 = require("../../errors");
const ObjectPropertiesProcessor = async (context) => {
    ...
    const tasks = Object.keys(properties).map(async (key) => {
        ...
        await (0, core_1.doValidate)(propValue, propRule, {
            ...context,
            path: childPath,
...
exports.ObjectPropertiesProcessor = ObjectPropertiesProcessor;
