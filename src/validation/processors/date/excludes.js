...
exports.DateExcludesProcessor = void 0;
const errors_1 = require("../../errors");
const DateExcludesProcessor = async (context) => {
    ...
    if (Array.isArray(excludesValues)) {
        ...
        const isExclude = excludesValues.some(excludeDate => value.getTime() === excludeDate.getTime());
        if (isExclude) {
            context.errors.push(errors_1.ValidationErrorBuilder.not_allowed(value, excludesValues, context));
        }
    }
};
exports.DateExcludesProcessor = DateExcludesProcessor;
