...
exports.RefreshContextStatusProcessor = void 0;
/**
 * 基础状态提取处理器
 * 权重建议设为很低（INITIAL 阶段）
 */
const RefreshContextStatusProcessor = async (context) => {
...
exports.RefreshContextStatusProcessor = RefreshContextStatusProcessor;
