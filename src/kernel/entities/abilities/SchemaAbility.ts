    ...
    protected onAttach(): void {
        ...
        if (cached) {
            Object.assign(this.host, {
                ...
                getKeys: () => {
                    const k: Schema = cached.schema || {} as any;
                    return {
                        id: k.idKey || 'id',
                        label: k.labelKey || 'name',
                        createdAt: k.createdAtKey || 'createdAt',
                        updatedAt: k.updatedAtKey || 'updatedAt',
                    };
                },
                ...
                getBehavior: () => {
                    ...
                    return (
                        {
                            sort: { prop:  k.defaultSort || 'id', order:  k.defaultOrder || 'desc' },
                            filters: k.filters || [],
                        }
                    );
                },
