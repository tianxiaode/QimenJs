 ...
 * 提供本地集合状态的访问和操作能力
 */
export interface IFlatLocalStateAbility<T extends IEntity, TSearch extends ILocalSearchParams, TState extends IFlatLocalEntityState<T, TSearch>> {
    /** 加载状态 */
 ...
 */
export interface IFlatLocalMutationAbility<T extends IEntity, TSearch extends ILocalSearchParams, TState extends IFlatLocalEntityState<T, TSearch>> {
    /**
     * 创建本地数据
     * @param item 要创建的项目
     */
 ...
 * 提供本地数据删除能力
 */
export interface IFlatLocalDeleteAbility<T extends IEntity, TSearch extends ILocalSearchParams, TState extends IFlatLocalEntityState<T, TSearch>> {
    /**
     * 删除本地数据
     * @param ids 要删除的ID数组
