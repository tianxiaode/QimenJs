...
exports.createFlowContext = void 0;
/**
 * 创建流上下文对象
 *
 ...
 */
const createFlowContext = (method, url, domain, domainConfig, requestOptions, entityName, action, schema) => {
    return {
        domain,
        entityName,
        action: action,
 ...
 * @returns 转换后的数据对象
 */
function applySchemaMapping(data, schema) {
    // 如果是数组，则递归处理数组中的每一项
