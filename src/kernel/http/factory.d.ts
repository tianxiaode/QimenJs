import { HttpMethod, RequestTask, RetryOptions, RequestOptions, PollingOptions } from '../types';
/**
 * HttpFactory 类
 *
...
export declare class HttpFactory {
     ...
     * // task.cancel('用户取消');
     */
    static createRetryTask(method: HttpMethod, url: string, options: RequestOptions & {
        retry?: RetryOptions;
    }, domain?: string): RequestTask;
    /**
     * 创建并调度一个周期性轮询任务
     *
     ...
     */
    static schedulePolling<T>(method: HttpMethod, url: string, pollingOptions: PollingOptions, domain?: string): void;
}
