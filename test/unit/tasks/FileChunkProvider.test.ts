import { FileChunkProvider } from '@/tasks/hash-task/chunk';
...
describe('FileChunkProvider', () => {
  ...
  it('should initialize with correct file path and chunk size', async () => {
    ...
    (fs.open as jest.MockedFunction<typeof fs.open>).mockResolvedValue(new MockFileHandle(testData) as any);
  ...
  it('should return correct number of chunks for a file', async () => {
    ...
    (fs.open as jest.MockedFunction<typeof fs.open>).mockResolvedValue(new MockFileHandle(smallData) as any);
  ...
  it('should handle chunking when file size is exactly divisible by chunk size', async () => {
    ...
    (fs.open as jest.MockedFunction<typeof fs.open>).mockResolvedValue(new MockFileHandle(data) as any);
