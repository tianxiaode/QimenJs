import { validateAdditionalProperties } from '@/utils/validation/validators/core/object/additional-properties';
import { ValidationErrorContext, ValidatorFunction } from '@/utils';
