...
describe('MIME Presets', () => {
  ...
  it('DOCUMENT_MIMES 应包含常用文档类型', () => {
    ...
    expect(DOCUMENT_MIMES.docx).toBe('application/vnd.openxmlformats-officedocument.wordprocessingml.document');
    expect(DOCUMENT_MIMES.xlsx).toBe('application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
  });
