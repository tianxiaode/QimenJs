import { gestureMap, keyboardGestureMap, gestureEventMap } from '@/kernel/events/adapters/semantic-map/gesture';
import { GestureEventMap, GestureSemantic } from '@/kernel/events/adapters/semantic-map/types';
