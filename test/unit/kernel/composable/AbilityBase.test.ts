...
import { IComposableBase, IExposeResult } from '@/kernel/types';
...
class TestAbility extends AbilityBase<TestHost> {
...
class TestAbilityWithSymbol extends AbilityBase<TestHost> {
  injectedProp = 'injected value';
...
class TestAbilityWithToString extends AbilityBase<TestHost> {
  toStringMethod() {
...
class TestAbilityWithConflictingProp extends AbilityBase<TestHost> {
...
describe('AbilityBase', () => {
  ...
  describe('dispose', () => {
    ...
    it('should call onDispose when disposing', () => {
      ...
      class TestDisposeTrackingAbility extends AbilityBase<TestHost> {
        disposed = false;
