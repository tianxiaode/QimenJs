...
jest.mock('@/event-dom/adapters/processors', () => ({
...
describe('DomEventAdapter', () => {
    ...
    describe('bind method', () => {
        ...
        it('should bind all required input signals for a gesture', () => {
            ...
            (createGestureProcessor as jest.MockedFunction<any>).mockImplementation(
                (descriptor: GestureEventDescriptor, callback: (event: any) => void) =>
                    mockProcessor
            );
    ...
    describe('bindInputSignals method', () => {
        it('should bind to the correct DOM events based on capabilities', () => {
            (detectInputCapabilities as jest.MockedFunction<any>).mockReturnValue({
                pointer: true,
            });
    ...
    describe('normalizeInput method', () => {
        ...
        it('should normalize TouchEvent correctly', () => {
            const touch = new (global as any).Touch({
                identifier: 0,
    ...
    describe('selectDomEvents method', () => {
        ...
        it('should prioritize pointer over touch and mouse when multiple capabilities are available', () => {
            ...
            expect(mockTarget.addEventListener).not.toHaveBeenCalledWith(
                'touchstart',
                expect.any(Function),
                undefined
            );
