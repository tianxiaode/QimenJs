import { baseMap } from '@/event-dom/adapters/semantic-map/base';
import { keyboardMap } from '@/event-dom/adapters/semantic-map/keyboard';
import { mouseMap } from '@/event-dom/adapters/semantic-map/mouse';
import { pointerMap } from '@/event-dom/adapters/semantic-map/pointer';
import { touchMap } from '@/event-dom/adapters/semantic-map/touch';
