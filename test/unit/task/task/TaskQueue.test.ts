import { GlobalTaskQueue, globalTaskQueue } from '@/task/task/TaskQueue';
...
describe('GlobalTaskQueue', () => {
    ...
    describe('runTask', () => {
        ...
        it('should execute a polling task and continue polling on success', async () => {
            ...
            const mockHandlePollingTask = jest
                .spyOn(taskQueue as any, 'handlePollingTask')
    ...
    describe('handlePollingTask', () => {
        ...
        it('should log error when polling task exceeds max retries', async () => {
            ...
            expect(loggerErrorSpy).toHaveBeenCalledWith(
                'Polling task test-id exceeded max retries'
            );
        });
    });
