...
jest.mock('@/event/adapters/utils/validation', () => {
    return {
...
import { DoubleTapProcessor } from '@/event/adapters/processors';
import { GestureEmit } from '@/event/adapters/processors/types';
import { InputSignal } from '@/event/adapters/semantic-map';
import { validateDoubleTap } from '@/event/adapters/utils/validation';
