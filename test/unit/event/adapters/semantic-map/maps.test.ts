import { baseMap } from '@/event/adapters/semantic-map/base';
import { keyboardMap } from '@/event/adapters/semantic-map/keyboard';
import { mouseMap } from '@/event/adapters/semantic-map/mouse';
import { pointerMap } from '@/event/adapters/semantic-map/pointer';
import { touchMap } from '@/event/adapters/semantic-map/touch';
